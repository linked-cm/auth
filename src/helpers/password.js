...
var PasswordHelper = {
     ...
     * @returns
     */
    generateHashedPassword: function (plainTextPassword) {
        return __awaiter(this, void 0, void 0, function () {
            var saltRounds, hashedPassword, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        saltRounds = 3;
                        return [4 /*yield*/, bcrypt_1.default.hash(plainTextPassword, saltRounds)];
                    case 1:
     ...
     * @returns
     */
    checkPassword: function (enteredPassword, hashedPassword) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, comparedPassword];
                }
            });
        });
    },
    ...
    validateResetPasswordToken: function (token) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, AuthCredential_js_1.AuthCredential.select(function (cred) { return cred.credentialOf; })
                            .where(function (cred) {
                    ...
                    case 1:
                        password = _a.sent();
                        return [2 /*return*/, password === null || password === void 0 ? void 0 : password.credentialOf];
                }
            });
        });
    },
