...
var RemoveAccountButton_module_css_1 = __importDefault(require("./RemoveAccountButton.module.css"));
...
var RemoveAccountButton = function (_a) {
    var confirmationText = _a.confirmationText, agreeText = _a.agreeText, className = _a.className, restProps = __rest(_a, ["confirmationText", "agreeText", "className"]);
    var _b = __read((0, react_1.useState)(false), 2), isModalOpen = _b[0], setIsModalOpen = _b[1];
    var auth = (0, useAuth_js_1.useAuth)();
    var t = (0, react_2.useTranslate)().t;
    var prefix = 'removeAccount';
    var onToggleModal = function () { return setIsModalOpen(!isModalOpen); };
    var onRemoveAccount = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            onToggleModal();
            auth.removeAccount().then(function (res) {
                if (res) {
                    auth.signout();
