...
const _this = __importStar(require("./auth.js"));
/**
...
var loadData = () => {
    if (typeof module !== 'undefined' && typeof exports !== 'undefined') {
        // CommonJS code path
        return Promise.resolve().then(() => __importStar(require('../data/auth.json')));
    }
    else {
        // ESM code path
        //@ts-ignore
        return Promise.resolve().then(() => __importStar(require('../data/auth.json'))).then((data) => data.default);
    }
};
